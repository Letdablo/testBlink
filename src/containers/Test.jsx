...
function Test() {
  ...
  const { setResponses} =useContext(ResultContext)
  const { valid ,testAnswers, testPossibleResponses} =useResults(temporalResponses);
  ...
  const drop = (ev) => {
    ...
    setTemporalResponses({ ...temporalResponses, [answer]: userResponse });
  }

  const saveResponses = () => {
    setResponses({ ...temporalResponses, done: true });
    navigate(`/`);
  }
  ...
  const resetResponses = () => {
    ...
    setTemporalResponses({ done: false });
  }
      ...
      <div className='bottom-bar exercise-resources'>
        ...
        <div className='exercise-content'>
          ...
          <div className="exercise-actions">
            ...
            <div className='button' disabled={valid} href='#' onClick={() => saveResponses()}>Guardar</div>
          </div>
        </div>
      </div>
